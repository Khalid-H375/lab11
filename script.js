...
function validate() {
	...
	if(fileName.match(/^\s*$/)) {                                            //check if a filename is entered                                            //check if a filename is entered
...
function init() {
	...
	$("#xmlForm").submit(function(event) {        //link function execute() to the submit event of the form
		event.preventDefault();                //prevent the default form submission
		execute();                            //call function execute()
	});
}
